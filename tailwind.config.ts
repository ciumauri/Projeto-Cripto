  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'faucet-gradient': 'linear-gradient(135deg, #00D4FF 0%, #8B5CF6 50%, #10B981 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      colors: {
        // FaucetChain Custom Colors
        'faucet-cyan': '#00D4FF',
        'faucet-purple': '#8B5CF6',
        'faucet-green': '#10B981',
        'faucet-dark': '#0F172A',
        'faucet-light': '#F1F5F9',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          ...
          '50%': { boxShadow: '0 0 20px #00D4FF, 0 0 30px #00D4FF, 0 0 40px #00D4FF' },
        },
        'float': {
